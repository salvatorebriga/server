<x-app-layout>
        ...
        <div class="space-y-4">
          @foreach ($messages as $message)
            <div
              ...
              <!-- Checkbox -->
              <input type="checkbox" class="dark:bg-gray-800 dark:border-none absolute top-1/2 left-6 cursor-pointer"
  ...
  <!-- Sponsorship Modal -->
  <div id="sponsorshipModal" class="fixed inset-0 bg-gray-600 bg-opacity-50 flex items-center justify-center z-50 ">
      ...
      <form id="sponsorship-form" method="POST" action="{{ route('sponsorship.store', $apartment->id) }}">
        ...
        <div>
          <label class="flex items-center mb-2">
            <input type="radio" name="sponsorship" value="basic" class="mr-2 accent-green-500 dark:accent-green-400">
...
>>>>>>> e9580e1d482a1023432a06a804c81c5cad45c014
        </div>
      </form>
    </div>
<<<<<<< HEAD
