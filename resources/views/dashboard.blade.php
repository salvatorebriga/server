        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div
                    ...
                    <p class="text-gray-600 dark:text-gray-300 mt-4">12,345</p>
                    <p class="text-gray-600 dark:text-gray-300 mt-2">Increased by 5% this week</p>
                </div>
                ...
                <div
                    ...
                    <h4 class="text-2xl font-semibold text-gray-800 dark:text-gray-200">New Messages</h4>
                    <p class="text-gray-600 dark:text-gray-300 mt-4">57</p>
                    <p class="text-gray-600 dark:text-gray-300 mt-2">3 unread messages</p>
                </div>
            </div>
