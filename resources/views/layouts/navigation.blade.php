<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
      ...
      <div class="flex">
        ...
        <div class="shrink-0 flex items-center">
          <a href="{{ route('dashboard') }}">
            ...
            <img src="{{ asset('img/boolbnb-logo.png') }}" alt="Logo" class=" h-8 w-auto" />
          </a>
        </div>
        ...
        <x-dropdown align="right" width="48">
          ...
          <x-slot name="content">
            ...
            <div
              ...
              <!-- Theme Toggle Button -->
              <button type="button" class="w-full text-left font-medium text-gray-800 dark:text-gray-400 rounded-md "
                onclick="toggleTheme()">
                <span class="inline-flex items-center">
                  <svg id="theme-icon" class="mr-2 w-5 h-5" xmlns="http://www.w3.org/2000/svg" width="24"
  ...
  <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
    <div class="pt-2 pb-3 space-y-1">
      ...
      <x-responsive-nav-link :href="route('apartments.index')" :active="request()->routeIs('apartments.*')">
        {{ __('My apartments') }}
      </x-responsive-nav-link>
    </div>
